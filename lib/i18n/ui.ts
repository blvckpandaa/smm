...
export const dict = {
  ru: {
    ...
    postsPerDayHint: "Выберите дни и количество постов — цену посчитаем сами.",
    freqTitle: "Ритм публикаций",
    freqPostingDays: "Дни публикации",
    freqPostsCount: "Постов за неделю",
    freqPostsCountHint: "Можно от 1 поста",
    freqPerDay: "в день",
    freqPerWeek: "в неделю",
    freqCost: "к оплате",
    freqEnough: "Баланса хватает",
    freqNeedTopup: "Нужно пополнить",
    freqPresetOne: "1 пост",
    freqPresetThree: "3 поста",
    freqPresetWeek: "7 постов",
    freqPresetActive: "14 постов",
    photoFree: "бесплатно",
    photoRegenerate: "Новое фото",
    photoCreate: "Создать фото",
  ...
  en: {
    ...
    postsPerDayHint: "Pick days and post count — we calculate the price.",
    freqTitle: "Posting pace",
    freqPostingDays: "Posting days",
    freqPostsCount: "Posts per week",
    freqPostsCountHint: "As few as 1 post",
    freqPerDay: "per day",
    freqPerWeek: "per week",
    freqCost: "to charge",
    freqEnough: "Balance is enough",
    freqNeedTopup: "Top up needed",
    freqPresetOne: "1 post",
    freqPresetThree: "3 posts",
    freqPresetWeek: "7 posts",
    freqPresetActive: "14 posts",
    photoFree: "free",
    photoRegenerate: "New photo",
